...
void TitleScreen::Start(SDL_Helper * helper)
{
	...
	this->m_logo = new Sprite(300, 70, helper, IMG_LOGO, 1, 1, 95, 95, 0, 0, false, false, 1);
	...
	this->m_creatorText = new Text(helper, "Manurocker95 (C) 2018", 465, 670, 35, true, FONT_ARKANOID_2, C_BLACK);
